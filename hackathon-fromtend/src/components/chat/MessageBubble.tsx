        ...
        >
            ...
            >
                <div className="flex items-end gap-2 mb-1">
                    ...
                    {isUser && (
                        <div className="h-8 w-8 rounded-full bg-secondary flex items-center justify-center mb-1 shrink-0 border border-border overflow-hidden">
                            <span className="text-xs font-medium">{dummyUser.avatar_initials}</span>
                        </div>
                    )}
                </div>
